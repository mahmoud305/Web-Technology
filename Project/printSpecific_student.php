...
mysqli_close($conn);}
 ...
 echo"<span style=\"color:#fff; font-size:xx-large; \">no books satisfies that condition</span>";
...
<style>
    body{
        text-align: center;
        background-image: url('student6.jpg');
        ...
        <form name="contactForm"   action="" method="POST" onsubmit="return validateForm()"> 
          ...
          <br><br>
           <div> 
            ...
            <br>
            <button  style="font-size :x-large; width:100% ; " onclick="document.location.href='mainstudent.html';" > &#8617;  Back</button>
        </form>
